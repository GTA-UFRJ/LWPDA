...
for exp_nome in NOMES_EXPERIMENTOS:
    ...
    diretorio_txts = DIRETORIO_PRINCIPAL / exp_nome / 'videos'   # Ajuste conforme necessário
...
if not dados_por_experimento:
    ...
    plt.savefig('/home/hugo/Desktop/LWPDA/graphs/output/video/boxplot_tempos_escala_log.png')
    ...
    plt.tight_layout()
    plt.savefig('/home/hugo/Desktop/LWPDA/graphs/output/video/boxplot_tempos_eixo_limitado.png')
    ...
    plt.tight_layout()
    plt.savefig('/home/hugo/Desktop/LWPDA/graphs/output/video/barras_tempos_media_escala_log.png')
    ...
    plt.savefig('/home/hugo/Desktop/LWPDA/graphs/output/video/boxplot_tempos.png')
    ...
    plt.savefig('/home/hugo/Desktop/LWPDA/graphs/output/video/barras_tempos_media.png')
