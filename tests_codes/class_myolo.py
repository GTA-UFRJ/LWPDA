...
class methods():
    def mean_squared_error(image1, image2,t):
        ...
        image1,image2 = np.array(image1,dtype='int64'),np.array(image2,dtype='int64')
        return np.mean(np.square(image2-image1))
        #return np.mean((image2 - image1) ** 2, dtype=np.float64)
    def histogram(image1,image2,t):
        ...
        if metric_val >= t: return True,metric_val
    ...
    def ssim(image1,image2,t):
        ...
        if ssim_score[0] >= t: return True,ssim_score[0]
        return False,ssim_score[0]
...
#image1 = 'C:/Users/hugol/Desktop/BetterYolo/tests_codes/black.jpg'
#image2 = 'C:/Users/hugol/Desktop/BetterYolo/tests_codes/white.jpg'
#diff = methods.mean_squared_error(cv.imread(image1),cv.imread(image2),1)
#print(diff)